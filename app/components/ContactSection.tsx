            ...
            <div className="max-w-4xl mx-auto">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <a
                            href="mailto:wilbertverayin@gmail.com"
                        ...
                        <a
                            href="https://drive.google.com/file/d/1z9zcd-9SZpSYVlnZ7GTOZOH-Wpd88ShB/view?usp=sharing"
                            target="_blank"
                    ...
                    <div className="flex justify-center gap-6">
                        <a
                            href="https://github.com/wilbertverayin"
                            target="_blank"
                        ...
                        <a
                            href="https://linkedin.com/in/wilbertverayin"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-full"
                        >
                        ...
                        <a
                            href="https://twitter.com/@wilbertverayin"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-full"
                        >
