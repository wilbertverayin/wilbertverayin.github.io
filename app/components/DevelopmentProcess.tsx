...
const processes: Process[] = [
    {
        ...
        steps: ['Requirements gathering and market research', 'User flow and wireframe design', 'Continuous clarification of requirements'],
    },
    {
        title: 'Development',
        colorClasses: {
    ...
    },
    {
        ...
        colorClasses: {
            ...
            hoverBorder: 'group-hover:border-green-500/20',
        },
        icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />,
        steps: ['Search Engine Optmization', 'Analytics integration and monitoring', 'Regular updates and feature enhancements'],
    },
];
        ...
        <section className="py-16 md:py-20 relative">
            <div className="container mx-auto px-4">
                ...
                <p className="text-sm sm:text-base text-gray-400 text-center mb-8 sm:mb-12 max-w-2xl mx-auto px-4">
                    A systematic approach to building scalable and robust systems
                </p>
